package com.htsing.pos.view.refresh;
...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent,
     ...
     * gesture.
     */
    public void setOnRefreshListener(@Nullable com.htsing.pos.view.refresh.SwipeRefreshLayout.OnRefreshListener listener) {
        mListener = listener;
    }
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        try {
            ...
            CommonViewUtils.setLog("SwipeRefreshLayout_onLayout", e.getMessage());
        }
