...
public class PostUtils {
    private static com.htsing.pos.utils.PostUtils postUtils;
    private BasePopupView popupView;

    public static com.htsing.pos.utils.PostUtils getInstance() {
        if (postUtils == null) {
            postUtils = new com.htsing.pos.utils.PostUtils();
        }
        return postUtils;
    }
