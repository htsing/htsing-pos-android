...
public class BigDecimalUtils {
    ...
    public static double sub(double v1, double v2, int scale) {
        ...
        BigDecimal b1 = new BigDecimal(v1);
        BigDecimal b2 = new BigDecimal(v2);
        String value = b1.subtract(b2).setScale(scale, BigDecimal.ROUND_HALF_UP).toString();
    ...
    public static double mul(double v1, double v2, int scale) {
        ...
        BigDecimal b1 = new BigDecimal(v1);
        BigDecimal b2 = new BigDecimal(v2);
        String valueStr = b1.multiply(b2).setScale(scale, BigDecimal.ROUND_HALF_UP).toString();
