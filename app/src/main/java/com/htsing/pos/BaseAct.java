...
import com.htsing.pos.utils.PostUtils;
...
//        initTint();
     ...
     * oauth2/token调用此方法
     */
    public <T> void easyPostLogin(JSONObject requestParams, String url, Class<T> cls, OnRequestSuccess<T> listener) {
        JsonParseUtils.easyPostLogin(this, requestParams, url, cls, listener);
    }
