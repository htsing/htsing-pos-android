...
public class HomeMemberInfo extends CommonResult {
    ...
    private List<HomeMemberInfo.DataBean> data;

    public List<HomeMemberInfo.DataBean> getData() {
        return data;
    }

    public void setData(List<HomeMemberInfo.DataBean> data) {
        this.data = data;
    }
