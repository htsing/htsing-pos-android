...
public class MenuBean implements Parcelable {
    ...
    public static final Creator<com.htsing.pos.bean.MenuBean> CREATOR = new Creator<com.htsing.pos.bean.MenuBean>() {
        @Override
        public com.htsing.pos.bean.MenuBean createFromParcel(Parcel source) {
            return new com.htsing.pos.bean.MenuBean(source);
        }

        @Override
        public com.htsing.pos.bean.MenuBean[] newArray(int size) {
            return new com.htsing.pos.bean.MenuBean[size];
        }
    };
