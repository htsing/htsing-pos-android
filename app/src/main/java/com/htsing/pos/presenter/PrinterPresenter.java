package com.htsing.pos.presenter;
...
import com.htsing.pos.utils.Utils;
...
//                            printerService.printTextWithFont("原账户余额:" + memberInfoBean.getOldAccount() + "\n", "", fontsizeContent, null);
                    ...
                    String shopName = PreferencesUtil.getString(context, Constant.SP_SHOPNAME);
                    String shopAddress = PreferencesUtil.getString(context, Constant.SP_SHOPADDRESS);
                    String mobile = PreferencesUtil.getString(context, Constant.SP_SHOPPHONE);
