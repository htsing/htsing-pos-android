...
//        initTint();
     ...
     * 默认需要token
     */
    public <T> void easyGet(HttpParams requestParams, String url, Class<T> cls, OnRequestSuccess<T> listener) {
     ...
     * 如果不需要token 则调用次方法
     */
    public <T> void easyGetWithOutToken(HttpParams requestParams, String url, Class<T> cls, OnRequestSuccess<T> listener) {
