...
public class HomeProductFragment extends HomeBaseFragment {
    ...
    private void getProducts() {
        try {
            ...
            mBact.showLoading();
            easyPost(json, GlobalServerUrl.DEBUG_URL + GlobalServerUrl.GETPRODUCTS, ProductListBean.class, stringResult -> {
...
//                cardList.addAll(data);
    ...
    private void initCataData() {
        try {
            ...
            json.put("shopId", "1");
//            showLoading();
            easyPost(json, GlobalServerUrl.DEBUG_URL + GlobalServerUrl.GETCATEGORY, CategoryBean.class, result -> {
